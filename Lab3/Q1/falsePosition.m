function [xroot, xl, xu, n, error] = falsePosition(xl0, xu0, max_its, tol )
%This function will implement the false position root finding method.
...
for n = 1:max_its
    ...
    if (n == 1) % 1ST ITERATION
        ...
        % Initial estimate of root (ie intersection of 2 lines)
        xroot = xu0 - ((fxu*(xl0-xu0))/(fxl-fxu));
        
        % Evaluate function at approx root
